...
( time -p ./kmeans-sycl_V100.x -o -n 10 -m 10 -l 10 -i ../data/10000_34f.txt ) 2>&1; echo
( time -p ./kmeans-sycl_V100.x -o -n 10 -m 10 -l 10 -i ../data/100000_34f.txt ) 2>&1; echo
( time -p ./kmeans-sycl_V100.x -o -n 10 -m 10 -l 10 -i ../data/1000000_34f.txt ) 2>&1; echo
